   ...
   var service = {
     ...
     actual_pedido: {},
        ...
        postOffer: function (offer) {
            $http({ method: 'POST', url: '/api/offer', data: offer }).
        ...
        putOffer: function (offer) {
            ...
            var id = offer.id;
            delete offer.id;
            $http({ method: 'PUT', url: '/api/offer/' + id , data: offer }).
             success(function (data, status, headers, config) {
                 console.log(data);
             }).
             error(function (data, status, headers, config) {
        ...
        removeOffer: function (id) {
            $http({ method: 'DELETE', url: '/api/offer/' + id }).
             success(function (data, status, headers, config) {
	    ...
	    getActualOrder: function (id) {
	        $http({ method: 'GET', url: '/api/order/'+id }).
	          success(function (data, status, headers, config) {
	    ...
	    getActualOffer: function (id) {
	        $http({ method: 'GET', url: '/api/offer/'+id }).
	          success(function (data, status, headers, config) {
	    ...
	    loadActualOffer: function () {
       	...
       	getPedidos: function () {
	        $http({ method: 'GET', url: '/api/accepted' }).
	          success(function (data, status, headers, config) {
