...
// declare the directive that will blur elements which are being loaded
.directive('loadingContent', ['requestNotificationChannel', function(requestNotificationChannel) {
    return {
        link: function(scope, element) {
            element.addClass('blur');
            requestNotificationChannel.onRequestStarted(scope, function() {element.addClass('blur')});
            requestNotificationChannel.onRequestEnded(scope, function() {element.removeClass('blur')});
        }
    }
}]);