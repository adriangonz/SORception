...
namespace Berenjena.ServiceTaller {
    ...
    public interface IGestionTaller {
        ...
        Berenjena.ServiceTaller.Taller getTaller(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGestionTaller/getTaller", ReplyAction="http://tempuri.org/IGestionTaller/getTallerResponse")]
        System.Threading.Tasks.Task<Berenjena.ServiceTaller.Taller> getTallerAsync(string token);
    ...
    public partial class GestionTallerClient : System.ServiceModel.ClientBase<Berenjena.ServiceTaller.IGestionTaller>, Berenjena.ServiceTaller.IGestionTaller {
        ...
        public Berenjena.ServiceTaller.Taller getTaller(string token) {
            return base.Channel.getTaller(token);
        }
        
        public System.Threading.Tasks.Task<Berenjena.ServiceTaller.Taller> getTallerAsync(string token) {
